...
void Chromagram::decomposeToTwelveBpo(const Preferences& prefs, int control){
	int bpo = prefs.getBpo(); // note this doesn't change when the data is decomposed. semantically problematic.
