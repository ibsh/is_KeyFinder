...
public:
  ...
  QString newString(const QString& newData, const QString& currentData, unsigned int charLimit, metadata_write_t write) const;
...
private:
  ...
  int scaledSine(int, double, double, int, int) const;
